...
ob_start();
	...
	{
		header("location:rpt_atd.php?id1=".$batch."&id2=".$adate );
	}
  ...
  <body>
    <div class="testbox">
      <form name="printIDForm" method="post" action="#">
		...
		<div class="item">
          <p>Date</p>
            <input type="date" name="adate" value="<?php echo $adate;?>"/><i class="fa fa-calendar"></i>
        </div>
        <div class="btn-block">
          <input type="submit" name="btnPrint" value="Generate Report">
        </div>
      </form>
    </div>
  </body>
